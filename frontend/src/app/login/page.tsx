        ...
        <div className="w-full max-w-sm space-y-8">
          ...
          <div className="space-y-3">
            <Button
              ...
              variant="outline"
              className="w-full border-zinc-700 bg-zinc-900/50 py-6 text-zinc-300 hover:border-zinc-600 hover:bg-zinc-800 hover:text-white"
            >
            ...
            <Button
              ...
              className="w-full border-zinc-700 bg-zinc-900/50 py-6 text-zinc-300 hover:border-zinc-600 hover:bg-zinc-800 hover:text-white"
            >
              <svg className="mr-3 size-5" viewBox="0 0 24 24" fill="currentColor">
